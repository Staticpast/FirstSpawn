...
# FirstSpawn Plugin Build and Deploy Script
...
readonly PLUGIN_NAME="FirstSpawn"
readonly PLUGIN_ARTIFACT_ID="FirstSpawn"

# GitHub configuration
readonly GITHUB_REPO="Staticpast/FirstSpawn"
...
Build and deploy the FirstSpawn plugin with intelligent change detection.
...
main() {
    ...
    log_info "Starting FirstSpawn plugin build and deployment..."
